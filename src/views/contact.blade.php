    ...
    <div class="contain">
        ...
        <div class="wrapper">
            ...
            <div class="form">
                ...
                <form id="submit-form" action="{{route('contact')}}" method="POST">
                    @csrf
                    <p>
                    ...
                    <p class="full-width">
                        <input id="company-name" class="form-input" type="text" placeholder="Company Name*" name="company_name" required>
                    </p>
                    <p class="full-width">
                        <textarea minlength="20" id="message" cols="30" rows="7" placeholder="Your Message*" required name="message"></textarea>
                    </p>
                    <p class="full-width">
                        <input type="checkbox" id="checkbox" checked> Yes, I would like to receive communications by call / email about Company's services.
                    </p>
                    <p class="full-width">
